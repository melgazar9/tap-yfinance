...
class TapYFinance(Tap):
    ...
    @staticmethod
    def discover_catalog_entry(asset_class, table_name: str, schema: dict) -> CatalogEntry:
    ...
    def catalog_dict(self) -> dict:
        ...
        # asset_table_names = [i for i in self.config.keys() if i.startswith('stocks') or i.startswith('forex') or i.startswith('crypto')]
    ...
    def discover_streams(self) -> list[YFinancePriceStream]:
        ...
        for catalog_entry in self.catalog_dict["streams"]:
            ...
            # stream.asset_class = catalog_entry['stream'].split('|')[0].split('_')[0]  # TODO: FIX HACK!
